...
export function buildEmailHtml(opts: BuildEmailHtmlOptions): string {
  ...
  const main = custom
    ? `<div style="background-color: #F8FAFC; border-radius: 8px; padding: 24px; margin-bottom: 24px; color: #1E3A5F; line-height: 1.7; font-size: 16px;">
  ...
  return `
    ...
    <body style="font-family: 'Inter', Arial, sans-serif; line-height: 1.7; font-size: 16px; color: #1E3A5F; max-width: 600px; margin: 0 auto; padding: 20px;">
      ${main}
